...
@celery.task(name="task_with_high_latency_and_full_core_usage")
def task_with_high_latency_and_full_core_usage(enqueued_time=None):
    task_id = task_with_high_latency_and_full_core_usage.request.id
